...
test_pops = [[45,45], [34, 34], [54, 54], [23, 23]]
...
for i in range(0, 10):
    ...
    offspring_pops, offspring_fits = tournament_selection.tournament_selection(test_pops, test_fits, test_tournament_size, len(test_pops))
...
fitness_selection = fitness_proportional(test_pops, test_fits)
for i in range(0, 10):
